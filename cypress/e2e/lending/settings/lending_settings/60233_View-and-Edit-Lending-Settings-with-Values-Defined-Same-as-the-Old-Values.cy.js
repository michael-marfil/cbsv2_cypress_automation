describe('View and Edit Lending Settings with Values Defined Same as the Old Values', () => {
    beforeEach(() => {
        cy.login();
    });
    ...
    it('should be able to view Lending Settings and can Edit (with values defined same as old)', () => {
